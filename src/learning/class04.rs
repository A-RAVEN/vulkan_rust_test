...
fn create_logical_device(instance: &ash::Instance, physical_device: vk::PhysicalDevice, validationInfo: &ValidationInfo) -> (ash::Device, vk::Queue)
{
    let indices = find_queue_family_indices(instance, physical_device);
    ...
    let enabled_layer_names_c: Vec<CString> = validationInfo
...
impl VulkanApp
{
    ...
    pub fn new() -> VulkanApp
    {
        ...
        let (logical_device, graphics_queue) = create_logical_device(&instance, physical_device, &VALIDATION);
